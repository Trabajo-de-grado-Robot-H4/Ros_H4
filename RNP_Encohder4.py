...
RoBPin4 = 13 
""" variables """
globalCounter1,globalCounter2,globalCounter3,globalCounter4 = 0.0,0.0,0.0,0.0
gain=0.97593582887
flag1=0
flag2=0
flag3=0
...
def rotaryDeal():
 ...
 while( not (GPIO.input(RoAPin1)) and GPIO.input(RoAPin2)) and GPIO.input(RoAPin3)) and GPIO.input(RoAPin4)) ) ):
